...
- **render:** consumer options at the melt boundary
- **transitions:** dissolve and slide as a plan of catalog verbs

### Fixed

- **project:** count Kdenlive's clock-valued blanks in the duration
...
- **transport:** the two transports disagreed about insert-clip, and HTTP could not read
